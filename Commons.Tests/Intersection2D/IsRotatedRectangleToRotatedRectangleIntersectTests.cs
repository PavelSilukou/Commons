...
public partial class IntersectionUtilsTests
{
	...
	public bool IsRotatedRectangleToRotatedRectangleIntersectValidateTests(Vector2[] rects)
	{
	...
	[Test, TestCaseSource(nameof(IsRotatedRectangleToRotatedRectangleIntersectTestsParameters))]
	public bool IsRotatedRectangleToRotatedRectangleIntersectValidate2Tests(Vector2[] rects)
	{
	...
	private static IEnumerable<TestCaseData> IsRotatedRectangleToRotatedRectangleIntersect2TestsParameters()
	{
		...
		yield return new TestCaseData(rects1);
		yield return new TestCaseData(rects2);
		yield return new TestCaseData(rects3);
		yield return new TestCaseData(rects4);
		yield return new TestCaseData(rects5);
		yield return new TestCaseData(rects6);
		yield return new TestCaseData(rects7);
		yield return new TestCaseData(rects8);
		yield return new TestCaseData(rects9);
		yield return new TestCaseData(rects10);
		yield return new TestCaseData(rects11);
		yield return new TestCaseData(rects12);
		yield return new TestCaseData(rects13);
		yield return new TestCaseData(rects14);
		yield return new TestCaseData(rects15);
		yield return new TestCaseData(rects16);
		yield return new TestCaseData(rects17);
		yield return new TestCaseData(rects18);
		yield return new TestCaseData(rects19);
		yield return new TestCaseData(rects20);
		yield return new TestCaseData(rects21);
		yield return new TestCaseData(rects22);
		yield return new TestCaseData(rects23);
		yield return new TestCaseData(rects24);
		yield return new TestCaseData(rects25);
		yield return new TestCaseData(rects26);
		yield return new TestCaseData(rects27);
		yield return new TestCaseData(rects28);
		yield return new TestCaseData(rects29);
		yield return new TestCaseData(rects30);
	}
	
	[Test, TestCaseSource(nameof(IsRotatedRectangleToRotatedRectangleIntersect2TestsParameters))]
	public void IsRotatedRectangleToRotatedRectangleIntersectValidate3Tests(Vector2[] rects)
	{
		var newRects = rects.Select(rect => Vector2Utils.RotateDeg(rect, 42.5f)).ToArray();
		var exception = Assert.Throws<ArithmeticException>(
			() => IntersectionUtils.IsRotatedRectangleToRotatedRectangleIntersect(
				newRects[0], newRects[1], newRects[2], newRects[3],
				newRects[4], newRects[5], newRects[6], newRects[7]
			)
		);
	...
	private static IEnumerable<TestCaseData> IsRotatedRectangleToRotatedRectangleIntersect3TestsParameters()
	{
		var rects1 = new[] { 
			new Vector2(30.0f, 40.0f), new Vector2(50.0f, 40.0f), new Vector2(50.0f, 30.0f), new Vector2(30.0f, 30.0f), // rect
			new Vector2(35.0f, 35.0f), new Vector2(35.0f, 35.0f), new Vector2(35.0f, 25.0f), new Vector2(35.0f, 25.0f)  // line segment
	...
	public bool IsRotatedRectangleToRotatedRectangleIntersectDoesNotValidate3Tests(Vector2[] rects)
	{
		...
		Assert.DoesNotThrow(
			() => isIntersect = IntersectionUtils.IsRotatedRectangleToRotatedRectangleIntersect(
				newRects[0], newRects[1], newRects[2], newRects[3],
				newRects[4], newRects[5], newRects[6], newRects[7],
				false
			)
