...
public partial class IntersectionUtilsTests
{
	private static IEnumerable<TestCaseData> IsLineToLineIntersectTestsParameters()
	{
		...
		yield return new TestCaseData(args15).Returns(true);
	...
	public bool IsLineToLineIntersectValidateTests(
		Vector2 point1,
		Vector2 point2,
		Vector2 point3,
		Vector2 point4
	...
	{
		var isIntersect = IntersectionUtils.IsLineToLineIntersect(
			point1, 
			point2, 
			point3, 
			point4
	...
	private static IEnumerable<TestCaseData> IsLineToLineIntersect2TestsParameters()
	{
		var args1 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(20.0f, 20.0f), new Vector2(10.0f, 20.0f), new Vector2(20.0f, 10.0f) };
		var args2 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(20.0f, 20.0f), new Vector2(50.0f, 10.0f), new Vector2(40.0f, 20.0f) };
		var args3 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 20.0f), new Vector2(30.0f, 10.0f), new Vector2(30.0f, 20.0f) };
		...
		yield return new TestCaseData(args15).Returns(returns1);
	...
	public (bool, Vector2[]) IsLineToLineIntersectValidate2Tests(
		Vector2 point1,
		Vector2 point2,
		Vector2 point3,
		Vector2 point4
	...
	private static IEnumerable<TestCaseData> IsLineToLineIntersect3TestsParameters()
	{
	...
	public bool IsLineToLineIntersectValidate3Tests(
		Vector2 point1,
		Vector2 point2,
		Vector2 point3,
		Vector2 point4
	)
	{
		...
		var exception = Assert.Throws<ArithmeticException>(
			() => isIntersect = IntersectionUtils.IsLineToLineIntersect(
				point1,
				point2, 
				point3, 
				point4
	...
	private static IEnumerable<TestCaseData> IsLineToLineIntersect4TestsParameters()
	{
		var args1 = new object?[] { new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f), new Vector2(10.0f, 10.0f), new Vector2(30.0f, 30.0f) };
		var args2 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(30.0f, 30.0f), new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f) };
		var args3 = new object?[] { new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f), new Vector2(20.0f, 10.0f), new Vector2(40.0f, 30.0f) };
	...
	public (bool, Vector2[]) IsLineToLineIntersectValidate4Tests(
		Vector2 point1,
		Vector2 point2,
		Vector2 point3,
		Vector2 point4
	...
	private static IEnumerable<TestCaseData> IsLineToLineIntersectSpecialTestsParameters()
	{
	...
	public void IsLineToLineIntersectValidateSpecialTests(
		Vector2 point1,
		Vector2 point2,
		Vector2 point3,
		Vector2 point4
	...
	{
		var exception = Assert.Throws<ArithmeticException>(
			() => IntersectionUtils.IsLineToLineIntersect(
				point1,
				point2, 
				point3, 
				point4
	...
	[Test, TestCaseSource(nameof(IsLineToLineIntersectSpecialTestsParameters))]
	public void IsLineToLineIntersectValidateSpecial2Tests(
		Vector2 point1,
		Vector2 point2,
		Vector2 point3,
		Vector2 point4
