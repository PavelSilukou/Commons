...
public partial class Intersection2DUtilsTests
{
	private static IEnumerable<TestCaseData> IsLineToLineIntersectTestsParameters()
	{
		...
		var args14 = new object?[] { new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f), new Vector2(10.0f, 10.0f), new Vector2(30.0f, 30.0f) };
		var args15 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(30.0f, 30.0f), new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f) };
		var args16 = new object?[] { new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f), new Vector2(20.0f, 10.0f), new Vector2(40.0f, 30.0f) };
		var args17 = new object?[] { new Vector2(20.0f, 10.0f), new Vector2(40.0f, 30.0f), new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f) };
		var args18 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f) };
		var args19 = new object?[] { new Vector2(20.0f, 20.0f), new Vector2(20.0f, 20.0f), new Vector2(10.0f, 10.0f), new Vector2(20.0f, 20.0f) };
		var args20 = new object?[] { new Vector2(-10.0f, -10.0f), new Vector2(20.0f, 20.0f), new Vector2(10.0f, 20.0f), new Vector2(20.0f, 10.0f) };
		var args21 = new object?[] { new Vector2(-10.0f, -10.0f), new Vector2(-20.0f, -20.0f), new Vector2(10.0f, 20.0f), new Vector2(20.0f, 10.0f) };
		var args22 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(20.0f, 20.0f), new Vector2(10.0f, 20.0f), new Vector2(50.0f, -20.0f) };
		var args23 = new object?[] { new Vector2(-10.0f, -10.0f), new Vector2(-20.0f, -20.0f), new Vector2(-10.0f, -20.0f), new Vector2(-20.0f, -10.0f) };
		...
		(bool, Vector2?) returns2 = (false, null);
		(bool, Vector2?) returns3 = (true, new Vector2(30.0f, 30.0f));
		(bool, Vector2?) returns4 = (true, new Vector2(20.0f, 20.0f));
		(bool, Vector2?) returns5 = (true, new Vector2(float.NaN, float.NaN));
		(bool, Vector2?) returns6 = (true, new Vector2(-15.0f, -15.0f));
		
		yield return new TestCaseData(args1).Returns(returns1);
		yield return new TestCaseData(args2).Returns(returns3);
		yield return new TestCaseData(args3).Returns(returns2);
		yield return new TestCaseData(args4).Returns(returns2);
		yield return new TestCaseData(args5).Returns(returns5);
		yield return new TestCaseData(args6).Returns(returns5);
		...
		yield return new TestCaseData(args10).Returns(returns5);
		yield return new TestCaseData(args11).Returns(returns5);
		yield return new TestCaseData(args12).Returns(returns5);
		yield return new TestCaseData(args13).Returns(returns4);
		yield return new TestCaseData(args14).Returns(returns2);
		yield return new TestCaseData(args15).Returns(returns2);
		yield return new TestCaseData(args16).Returns(returns2);
		yield return new TestCaseData(args17).Returns(returns2);
		...
		yield return new TestCaseData(args22).Returns(returns1);
		yield return new TestCaseData(args23).Returns(returns6);
		
		yield return new TestCaseData(argsSpecial1).Returns(returns2);
		yield return new TestCaseData(argsSpecial2).Returns(returns2);
		yield return new TestCaseData(argsSpecial3).Returns(returns2);
		yield return new TestCaseData(argsSpecial4).Returns(returns2);
		yield return new TestCaseData(argsSpecial5).Returns(returns2);
		yield return new TestCaseData(argsSpecial6).Returns(returns2);
		yield return new TestCaseData(argsSpecial7).Returns(returns2);
		yield return new TestCaseData(argsSpecial8).Returns(returns2);
		
		yield return new TestCaseData(argsSpecial9).Returns(returns2);
		yield return new TestCaseData(argsSpecial10).Returns(returns2);
		yield return new TestCaseData(argsSpecial11).Returns(returns2);
		yield return new TestCaseData(argsSpecial12).Returns(returns2);
		yield return new TestCaseData(argsSpecial13).Returns(returns2);
		yield return new TestCaseData(argsSpecial14).Returns(returns2);
		yield return new TestCaseData(argsSpecial15).Returns(returns2);
		yield return new TestCaseData(argsSpecial16).Returns(returns2);
		
		yield return new TestCaseData(argsSpecial17).Returns(returns2);
		yield return new TestCaseData(argsSpecial18).Returns(returns2);
		yield return new TestCaseData(argsSpecial19).Returns(returns2);
		yield return new TestCaseData(argsSpecial20).Returns(returns2);
		yield return new TestCaseData(argsSpecial21).Returns(returns2);
		yield return new TestCaseData(argsSpecial22).Returns(returns2);
		yield return new TestCaseData(argsSpecial23).Returns(returns2);
		yield return new TestCaseData(argsSpecial24).Returns(returns2);
	}
	
	[Test, TestCaseSource(nameof(IsLineToLineIntersectTestsParameters))]
	public (bool, Vector2?) IsLineToLineIntersectTests(
		Vector2 point1,
		Vector2 point2,
		Vector2 point3,
		Vector2 point4
	...
	{
		var isIntersect = Intersection2DUtils.IsLineToLineIntersect(
