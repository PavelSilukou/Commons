...
public partial class Intersection2DUtilsTests
{
	private static IEnumerable<TestCaseData> IsArcToArcIntersectTestsParameters()
	{
		...
		var args19 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 15.0f), 0.0f, new Vector2(10.0f, 10.0f), new Vector2(10.0f, 15.0f), 0.0f };
		var args20 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 10.0f), 0.0f, new Vector2(10.0f, 10.0f), new Vector2(10.0f, 10.0f), 0.0f };
		var args21 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 10.0f), 180.0f, new Vector2(10.0f, 10.0f), new Vector2(10.0f, 10.0f), 180.0f };
		
		var args22 = new object?[] { new Vector2(-10.0f, -10.0f), new Vector2(-10.0f, -19.0f), -180.0f, new Vector2(-20.0f, -10.0f), new Vector2(-20.0f, -19.0f), 180.0f };
		...
		var argsSpecial5 =new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 19.0f), float.NaN, new Vector2(20.0f, 10.0f), new Vector2(20.0f, 19.0f), 180.0f };
		...
		var argsSpecial10 =new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 19.0f), -180.0f, new Vector2(20.0f, 10.0f), new Vector2(20.0f, 19.0f), float.NaN };
		...
		var argsSpecial15 =new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 19.0f), float.PositiveInfinity, new Vector2(20.0f, 10.0f), new Vector2(20.0f, 19.0f), 180.0f };
		...
		var argsSpecial20 =new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 19.0f), -180.0f, new Vector2(20.0f, 10.0f), new Vector2(20.0f, 19.0f), float.PositiveInfinity };
		...
		var argsSpecial25 =new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 19.0f), float.NegativeInfinity, new Vector2(20.0f, 10.0f), new Vector2(20.0f, 19.0f), 180.0f };
		...
		var argsSpecial30 =new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 19.0f), -180.0f, new Vector2(20.0f, 10.0f), new Vector2(20.0f, 19.0f), float.NegativeInfinity };
		
		(bool, Vector2?, Vector2?) returns1 = (true, new Vector2(15.0f, 2.516685f), new Vector2(15.0f, 17.483315f));
		(bool, Vector2?, Vector2?) returns2 = (true, null, new Vector2(15.0f, 17.483315f));
		(bool, Vector2?, Vector2?) returns3 = (true, new Vector2(15.0f, 2.516685f), null);
		(bool, Vector2?, Vector2?) returns4 = (false, null, null);
		(bool, Vector2?, Vector2?) returns5 = (true, new Vector2(15.0f, 10.0f), new Vector2(15.0f, 10.0f));
		(bool, Vector2?, Vector2?) returns6 = (true, new Vector2(10.0f, 14.0f), new Vector2(10.0f, 6.0f));
		(bool, Vector2?, Vector2?) returns7 = (true, null, new Vector2(6.0f, 10.0f));
		(bool, Vector2?, Vector2?) returns8 = (true, new Vector2(float.NaN, float.NaN), new Vector2(float.NaN, float.NaN));
		(bool, Vector2?, Vector2?) returns9 = (true, new Vector2(-15.0f, -2.516685f), new Vector2(-15.0f, -17.483315f));
		...
		yield return new TestCaseData(args22).Returns(returns9);
		
		yield return new TestCaseData(argsSpecial1).Returns(returns4);
		yield return new TestCaseData(argsSpecial2).Returns(returns4);
		yield return new TestCaseData(argsSpecial3).Returns(returns4);
		yield return new TestCaseData(argsSpecial4).Returns(returns4);
		yield return new TestCaseData(argsSpecial5).Returns(returns4);
		yield return new TestCaseData(argsSpecial6).Returns(returns4);
		yield return new TestCaseData(argsSpecial7).Returns(returns4);
		yield return new TestCaseData(argsSpecial8).Returns(returns4);
		yield return new TestCaseData(argsSpecial9).Returns(returns4);
		yield return new TestCaseData(argsSpecial10).Returns(returns4);
		
		yield return new TestCaseData(argsSpecial11).Returns(returns4);
		yield return new TestCaseData(argsSpecial12).Returns(returns4);
		yield return new TestCaseData(argsSpecial13).Returns(returns4);
		yield return new TestCaseData(argsSpecial14).Returns(returns4);
		yield return new TestCaseData(argsSpecial15).Returns(returns4);
		yield return new TestCaseData(argsSpecial16).Returns(returns4);
		yield return new TestCaseData(argsSpecial17).Returns(returns4);
		yield return new TestCaseData(argsSpecial18).Returns(returns4);
		yield return new TestCaseData(argsSpecial19).Returns(returns4);
		yield return new TestCaseData(argsSpecial20).Returns(returns4);
		
		yield return new TestCaseData(argsSpecial21).Returns(returns4);
		yield return new TestCaseData(argsSpecial22).Returns(returns4);
		yield return new TestCaseData(argsSpecial23).Returns(returns4);
		yield return new TestCaseData(argsSpecial24).Returns(returns4);
		yield return new TestCaseData(argsSpecial25).Returns(returns4);
		yield return new TestCaseData(argsSpecial26).Returns(returns4);
		yield return new TestCaseData(argsSpecial27).Returns(returns4);
		yield return new TestCaseData(argsSpecial28).Returns(returns4);
		yield return new TestCaseData(argsSpecial29).Returns(returns4);
		yield return new TestCaseData(argsSpecial30).Returns(returns4);
	}
	
	[Test, TestCaseSource(nameof(IsArcToArcIntersectTestsParameters))]
	public (bool, Vector2?, Vector2?) IsArcToArcIntersectTests(
		Vector2 arc1Center,
		Vector2 arc1Point, 
		float arc1AngleDeg,
		Vector2 arc2Center,
	...
	{
		var isIntersect = Intersection2DUtils.IsArcToArcIntersect(
		...
		return (isIntersect, intersectionPoint1, intersectionPoint2);
	}
}