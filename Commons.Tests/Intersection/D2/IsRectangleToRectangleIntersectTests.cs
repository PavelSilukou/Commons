...
public partial class IntersectionUtilsTests
{
	...
	public bool IsRectangleToRectangleIntersectValidateTests(float[] rects)
	{
	...
	public void IsRectangleToRectangleIntersectValidate2Tests(float[] rects)
	{
	...
	private static IEnumerable<TestCaseData> IsRectangleToRectangleIntersect3TestsParameters()
	{
		var rects1 = new[] { 
			30.0f, 40.0f, 50.0f, 30.0f, // rect
			35.0f, 35.0f, 35.0f, 25.0f  // line segment
	...
	public bool IsRectangleToRectangleIntersectDontValidate2Tests(float[] rects)
	{
		...
		Assert.DoesNotThrow(
			() => isIntersect = IntersectionUtils.IsRectangleToRectangleIntersect(
				rects[0], rects[1], rects[2], rects[3],
				rects[4], rects[5], rects[6], rects[7],
				false
			)
