...
public partial class Intersection2DUtilsTests
{
	private static IEnumerable<TestCaseData> IsArcToCircleIntersectTestsParameters()
	{
		...
		var args13 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(5.0f, 10.0f), -180.0f, new Vector2(10.0f, 15.0f), 0.0f };
		var args14 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(5.0f, 10.0f), -180.0f, new Vector2(10.0f, 16.0f), 0.0f };
		var args15 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(5.0f, 10.0f), -180.0f, new Vector2(10.0f, 10.0f), -9.0f };
		var args16 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 15.0f), 0.0f, new Vector2(10.0f, 15.0f), 0.0f };
		var args17 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 15.0f), 0.0f, new Vector2(10.0f, 16.0f), 0.0f };
		var args18 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 10.0f), 0.0f, new Vector2(10.0f, 10.0f), 0.0f };
		var args19 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 10.0f), 0.0f, new Vector2(15.0f, 15.0f), 0.0f };
		var args20 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 10.0f), 180.0f, new Vector2(10.0f, 10.0f), 0.0f };
		var args21 = new object?[] { new Vector2(-10.0f, -10.0f), new Vector2(-10.0f, -19.0f), -180.0f, new Vector2(-20.0f, -10.0f), 9.0f };
		...
		var argsSpecial5 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 19.0f), float.NaN, new Vector2(20.0f, 10.0f), 9.0f };
		...
		var argsSpecial13 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 19.0f), float.PositiveInfinity, new Vector2(20.0f, 10.0f), 9.0f };
		...
		var argsSpecial21 = new object?[] { new Vector2(10.0f, 10.0f), new Vector2(10.0f, 19.0f), float.NegativeInfinity, new Vector2(20.0f, 10.0f), 9.0f };
		...
		(bool, Vector2?, Vector2?) returns6 = (true, new Vector2(float.NaN, float.NaN), new Vector2(float.NaN, float.NaN));
		(bool, Vector2?, Vector2?) returns7 = (true, new Vector2(-15.0f, -2.516685f), new Vector2(-15.0f, -17.483315f));
		...
		yield return new TestCaseData(args14).Returns(returns4);
		...
		yield return new TestCaseData(args21).Returns(returns7);
	...
	public (bool, Vector2?, Vector2?) IsArcToCircleIntersectTests(
		Vector2 arcCenter,
		Vector2 arcPoint, 
		float arcAngleDeg,
	...
	{
		var isIntersect = Intersection2DUtils.IsArcToCircleIntersect(
