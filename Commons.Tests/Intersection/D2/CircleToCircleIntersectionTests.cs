...
{
	private static IEnumerable<TestCaseData> CircleToCircleIntersectionTestsParameters()
	{
		...
		(bool, Vector2?, Vector2?) returns2 = (true, new Vector2(15.0f, 10.0f), new Vector2(15.0f, 10.0f));
		(bool, Vector2?, Vector2?) returns3 = (false, null, null);
		(bool, Vector2?, Vector2?) returns4 = (true, new Vector2(float.NaN, float.NaN), new Vector2(float.NaN, float.NaN));
		(bool, Vector2?, Vector2?) returns5 = (true, new Vector2(-15.0f, -2.516685f), new Vector2(-15.0f, -17.483315f));
		...
		yield return new TestCaseData(args7).Returns(returns3);
		...
		yield return new TestCaseData(args13).Returns(returns5);
		
		yield return new TestCaseData(argsSpecial1).Returns(returns3);
		yield return new TestCaseData(argsSpecial2).Returns(returns3);
		yield return new TestCaseData(argsSpecial3).Returns(returns3);
		yield return new TestCaseData(argsSpecial4).Returns(returns3);
		yield return new TestCaseData(argsSpecial5).Returns(returns3);
		yield return new TestCaseData(argsSpecial6).Returns(returns3);
		yield return new TestCaseData(argsSpecial7).Returns(returns3);
		yield return new TestCaseData(argsSpecial8).Returns(returns3);
		yield return new TestCaseData(argsSpecial9).Returns(returns3);
		yield return new TestCaseData(argsSpecial10).Returns(returns3);
		yield return new TestCaseData(argsSpecial11).Returns(returns3);
		yield return new TestCaseData(argsSpecial12).Returns(returns3);
		yield return new TestCaseData(argsSpecial13).Returns(returns3);
		yield return new TestCaseData(argsSpecial14).Returns(returns3);
		yield return new TestCaseData(argsSpecial15).Returns(returns3);
		yield return new TestCaseData(argsSpecial16).Returns(returns3);
		yield return new TestCaseData(argsSpecial17).Returns(returns3);
		yield return new TestCaseData(argsSpecial18).Returns(returns3);
	}
	
	[Test, TestCaseSource(nameof(CircleToCircleIntersectionTestsParameters))]
	public (bool, Vector2?, Vector2?) CircleToCircleIntersectionTests(
		Vector2 center1,
		float radius1,
		Vector2 center2,
		float radius2
	...
	{
		var isIntersect = Intersection2DUtils.IsCircleToCircleIntersect(
