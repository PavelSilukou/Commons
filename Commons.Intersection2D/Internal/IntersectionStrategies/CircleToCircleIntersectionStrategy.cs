...
{
	internal class CircleToCircleIntersectionStrategy: IntersectionStrategy<Circle, Circle>
	{
		public override FormTypesPair[] GetFormTypes()
		{
			return new[]
			{
				new FormTypesPair(typeof(Circle), typeof(Circle))
			};
		}

		protected override bool IsIntersect(Circle circle1, Circle circle2)
		{
		...
		protected override bool IsIntersect(out Vector2[] intersectionPoints, Circle circle1, Circle circle2)
		{
