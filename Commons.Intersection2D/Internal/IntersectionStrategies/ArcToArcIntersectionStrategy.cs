...
{
	internal class ArcToArcIntersectionStrategy: IntersectionStrategy<Arc, Arc>
	{
		...
		public override FormTypesPair[] GetFormTypes()
		{
			return new[]
			{
				new FormTypesPair(typeof(Arc), typeof(Arc))
			};
		}

		protected override bool IsIntersect(Arc arc1, Arc arc2)
		{
			return IsIntersect(out _, arc1, arc2);
		}

		protected override bool IsIntersect(out Vector2[] intersectionPoints, Arc arc1, Arc arc2)
		{
			...
			var circlesIntersection = _circleToCircleIntersectionStrategy.IsIntersect(
				...
				new Circle(arc1.Center, arc1.Radius),
				new Circle(arc2.Center, arc2.Radius)
			);
		...
		)
		{
			...
			var angle1Point1 =
				Vector2Utils.SignedAngleDeg360(arc1.Point - arc1.Center, arc2.Point - arc1.Center, arc1.AngleSign);
			var angle1Point2 =
				Vector2Utils.SignedAngleDeg360(arc1.Point - arc1.Center, arc2Point2 - arc1.Center, arc1.AngleSign);
			var angle2Point1 =
				Vector2Utils.SignedAngleDeg360(arc2.Point - arc1.Center, arc1.Point - arc1.Center, arc2.AngleSign);
			var angle2Point2 =
				Vector2Utils.SignedAngleDeg360(arc2.Point - arc1.Center, arc1Point2 - arc1.Center, arc2.AngleSign);
