...
{
	internal class LineSegmentToLineSegmentIntersectionStrategy: IntersectionStrategy<LineSegment, LineSegment>
	{
		public override FormTypesPair[] GetFormTypes()
		{
			return new[]
			{
				new FormTypesPair(typeof(LineSegment), typeof(LineSegment))
			};
		}

		protected override bool IsIntersect(LineSegment lineSegment1, LineSegment lineSegment2)
		{
			return IsIntersect(out _, lineSegment1, lineSegment2);
		}

#pragma warning disable S3776 // Cognitive Complexity of methods should not be too high
		protected override bool IsIntersect(out Vector2[] intersectionPoints, LineSegment lineSegment1, LineSegment lineSegment2)
		{
